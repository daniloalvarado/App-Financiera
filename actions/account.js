...
const serializeDecimal = (obj) => {
  ...
  if (obj.initialBalance) {
    serialized.initialBalance = obj.initialBalance.toNumber();
  }
  if (obj.amount) {
...
export async function updateAccount(accountId, data) {
  try {
    ...
    if (data.initialBalance !== undefined) {
      const newInitialBalance = parseFloat(data.initialBalance);
      const oldInitialBalance = account.initialBalance.toNumber();
      const balanceDifference = newInitialBalance - oldInitialBalance;
      
      // El nuevo saldo es el saldo actual más la diferencia
      updateData.initialBalance = newInitialBalance;
      updateData.balance = account.balance.toNumber() + balanceDifference;
    }
