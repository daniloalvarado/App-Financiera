...
export function TransactionTable({ transactions }) {
  ...
  const handleBulkDelete = async () => {
    if (
      !window.confirm(
        `¿Está seguro de que desea eliminar ${selectedIds.length} transacciones?`
      )
    )
      return;
  ...
  useEffect(() => {
    if (deleted && !deleteLoading) {
      toast.error("Transacciones eliminadas exitosamente");
    }
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="non-recurring">Solo No Recurrentes</SelectItem>
            </SelectContent>
          </Select>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <div className="text-sm">
                              <div className="font-medium">Próxima Fecha:</div>
                              <div>
                                {format(
